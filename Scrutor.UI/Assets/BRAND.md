...
|------|-----------|---------|
| `scrutor-icon.png` | Window icon + header tile (32–48px) | **Simple** — thick strokes, few shapes |
| `scrutor-watermark.png` | Center panel background watermark (~300px) | **Full** — board mark at soft opacity |
| `scrutor-logo-full.png` | About / marketing large | **Full** |
| `scrutor-lockup.png` | Horizontal mark + wordmark | Medium |
