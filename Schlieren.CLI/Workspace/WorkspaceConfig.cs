...
namespace Schlieren.CLI.Workspace;

/// <summary>
/// The schlieren.config.json workspace configuration — replaces hardhat.config.js.
/// Lives in the project root created by 'schlieren init'.
/// </summary>
public sealed class WorkspaceConfig
{
    public static readonly string FileName = "schlieren.config.json";
    ...
    /// <summary>
    /// Walk up from <paramref name="startDir"/> until schlieren.config.json is found.
