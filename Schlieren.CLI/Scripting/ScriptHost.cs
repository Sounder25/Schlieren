...
{
    /// <summary>Live RPC connection to the running Schlieren node.</summary>
    public SchlierenNode node { get; init; } = null!;
...
public static class ScriptHost
{
    ...
    {
        typeof(SchlierenNode).Assembly,                          // Schlieren.CLI
        typeof(Schlieren.Core.Primitives.CryptoUtils).Assembly, // Schlieren.Core
        ...
        string[] accounts)
    {
        ...
        var wrapped = $"""
// --- schlieren test runner preamble ---
