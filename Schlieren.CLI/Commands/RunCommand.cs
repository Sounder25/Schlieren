...
/// <summary>
/// schlieren run &lt;script.csx&gt; [--rpc http://127.0.0.1:8545]
///
/// Runs a C# script against a Schlieren node. If --rpc is omitted the command
/// starts an embedded node using the workspace configuration (schlieren.config.json),
...
public static class RunCommand
{
    public static async Task<int> RunAsync(string scriptPath, string? rpcUrl, string? workdir)
    {
        ...
        await using var node = new SchlierenNode(
            resolvedRpc,
