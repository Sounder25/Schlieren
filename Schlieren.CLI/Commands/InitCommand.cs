...
/// <summary>
/// schlieren init [directory]
/// Creates a new Schlieren workspace with scaffolding and schlieren.config.json.
/// </summary>
public static class InitCommand
{
    public static async Task<int> RunAsync(string? directory)
    {
        ...
        {
            Console.Error.WriteLine($"✗  Already a Schlieren workspace: {existing}");
            return 1;
        }
        ...
        Console.WriteLine();
        Console.WriteLine("  schlieren.config.json   — network, compiler, account settings");
        ...
        Console.WriteLine("  schlieren node          — start the local node");
        Console.WriteLine("  schlieren compile       — compile contracts");
        Console.WriteLine("  schlieren run scripts/deploy.csx");
        Console.WriteLine("  schlieren test");
