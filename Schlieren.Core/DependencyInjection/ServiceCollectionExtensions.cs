...
namespace Schlieren.Core.DependencyInjection;

public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddSchlierenCore(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IChainState>(sp =>
        {
            ...
            if (!string.IsNullOrEmpty(config.ForkUrl))
            {
                ...
                Schlieren.Core.Models.Block? forkBlock;
        ...
        services.AddHostedService<Schlieren.Core.Services.BootstrapService>();
